...
static const int64 nTargetTimespan = 4 * 60 * 60; // KaChingCoin: 4 hours
static const int64 nTargetSpacing = 60; // KaChingCoin: 60 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal KaChingCoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa01d584d41cbc690a778f1b1cab394d2962993c06d997780687fba6d49e8464a");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1394305586;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   =  389148548;

        if (fTestNet)
        {
            block.nTime    = 1394240444;
            block.nNonce   = 387763152;
        }
